...
Terminal.prototype.bootstrap = function() {
  ...
  var element = {
    ...
    getBoundingClientRect: function() { return { height: this.height, width: this.width } },
...
Terminal.prototype.__render = function() {
  var __schedule = function() { this.screen.render(); this._render_queued = false; }.bind( this );
  if ( ! this._render_queued ) { this._render_queued = true; setTimeout( __schedule, 10 ); }
}
